...
const malaysia: DestinationSource = {
  ...
  visa: {
    required: false,
    type: 'Visa free entry for Indian passport holders, currently up to 30 days',
    timeline: 'Nothing to apply for. You clear immigration on arrival.',
    feeInr: 0,
...
const bali: DestinationSource = {
  ...
  visa: {
    required: true,
    type: 'Indonesia visa on arrival, 30 days, extendable once',
    timeline: 'Issued at the airport, or applied for online before you fly',
    feeInr: 3200,
    documents: DEFAULT_VISA_DOCS,
