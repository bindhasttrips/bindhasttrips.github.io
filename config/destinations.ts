...
const uae: Destination = {
  ...
  summary:
    'Three and a half hours from Mumbai, with English and Hindi spoken almost everywhere and Indian food widely available. Dubai and Abu Dhabi sit ninety minutes apart, so most trips combine the two. Entry is straightforward and the infrastructure is excellent.',
...
const thailand: Destination = {
  ...
  summary:
    'Costs on the ground are roughly half those in the UAE, and Indian passport holders currently enter without a visa. Bangkok covers the city and the food, the southern islands cover the beaches, and the north is cooler, greener and much slower. Six bases to choose between.',
